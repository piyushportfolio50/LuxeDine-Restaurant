                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {paymentMethods.map((method) => (
                          <label
                            key={method.id}
                            className={`p-4 border cursor-pointer transition-colors flex flex-col items-center gap-2 ${paymentMethod === method.id
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            {banks.map((bank) => (
                              <button
                                ...
                                className={`p-3 border text-sm transition-colors ${selectedBank === bank.id
